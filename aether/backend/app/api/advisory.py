...
def generate_advisory_with_llm(request: AdvisoryRequest, aqi: float | None, category: str, db: Session) -> str | None:
...
def get_offline_advisory(question: str, aqi: float | None, category: str, lang: str) -> str | None:
    ...
    if any(k in q_lower for k in [
        "jog", "run", "exercise", "walk", "sport", "play", "outdoor", "outside", "swim", "cycle", "gym", "cardio", "breathe", "running", "jogging", "sports", "workout", "workouts",
        "ব্যায়াম", "দৌড়", "হাঁটা", "খেলা", "ব্যায়াম", "দৌড়",
        "व्यायाम", "दौड़", "दौड़ने", "खेल", "कसरत", "सैर"
    ]):
        topic = "exercise"
    elif any(k in q_lower for k in [
        "old", "elderly", "grand", "parent", "kid", "child", "baby", "son", "daughter", "school", "asthma", "heart", "pregnant", "mother", "family", "senior", "seniors", "kids", "children", "asthmatic",
        "শিশু", "বয়স্ক", "বয়স্ক", "বাচ্চা", "হাঁপানি", "গর্ভবতী",
        "बच्चे", "बुजुर्ग", "बच्चा", "बूढ़े", "अस्थमा", "गर्भवती"
    ]):
        topic = "sensitive"
    elif any(k in q_lower for k in [
        "mask", "n95", "filter", "ppe", "wear", "respirator", "masks",
        "মাস্ক",
        "मास्क"
    ]):
        topic = "mask"
    elif any(k in q_lower for k in [
        "window", "door", "ventilation", "indoor", "purifier", "clean air", "open", "close", "purifiers", "hepa",
        "জানালা", "দরজা", "ভেতরে", "পিউরিফায়ার",
        "खिड़की", "दरवाजा", "कमरे", "प्यूरिफायर"
    ]):
        topic = "indoor"
    elif any(k in q_lower for k in [
        "cough", "eye", "headache", "chest", "throat", "breath", "burn", "sick", "ache", "pain", "allergy", "coughing", "throat", "eyes",
        "কাশি", "চোখ", "মাথাব্যথা", "গলা", "শ্বাস",
        "खांसी", "आँख", "आंक", "सिरदर्द", "गले", "सांस"
    ]):
        topic = "symptoms"
    elif any(k in q_lower for k in [
        "travel", "commute", "work", "office", "go to", "car", "metro", "drive", "bus", "road", "vehicle",
        "ভ্রমণ", "যাতায়াত", "অফিস", "গাড়ি", "মেট্রো",
        "यात्रा", "ऑफिस", "गाड़ी", "मेट्रो", "सफर"
    ]):
        topic = "travel"
