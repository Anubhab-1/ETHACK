                    ...
                    <div key={report.id} className="glass-card p-4 flex flex-col justify-between space-y-3 relative hover:border-white/15 transition-all">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="space-y-0.5">
                          <span className={`text-[9px] px-1.5 py-0.5 font-bold uppercase rounded ${report.severity === "high" ? "bg-red-500/10 text-red-400 border border-red-500/20" : report.severity === "medium" ? "bg-orange-500/10 text-orange-400 border border-orange-500/20" : "bg-yellow-500/10 text-yellow-400 border border-yellow-500/20"
                            }`}>
                        ...
                        <span className={`text-[9px] px-2 py-0.5 rounded font-black border uppercase ${report.status === "verified" ? "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" : report.status === "resolved" ? "bg-purple-500/10 text-purple-400 border-purple-500/20" : "bg-gray-500/10 text-gray-400 border-white/5"
                          }`}>
                          {report.status}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {[
                          ...
                          <button
                            ...
                            className={`p-2 rounded text-center border text-[10px] flex flex-col items-center justify-center transition-colors cursor-pointer ${severity === s.val
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {PRESET_PHOTOS.map((p) => (
                          <button
                            ...
                            className={`p-2 rounded text-left border text-[10px] transition-colors cursor-pointer ${presetPhoto === p.id
